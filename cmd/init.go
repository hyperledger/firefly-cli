...
func init() {
	...
	initCmd.Flags().StringArrayVarP(&tokenProvidersSelection, "token-providers", "t", []string{"erc1155", "erc20erc721"}, fmt.Sprintf("Token providers to use. Options are: %v", stacks.ValidTokenProviders))
